...
void AtUart::Initialize() {
    ...
    ESP_ERROR_CHECK(uart_driver_install(uart_num_, 16384, 0, 200, &event_queue_handle_, ESP_INTR_FLAG_IRAM));
    ...
    }, "modem_receive", 2048 * 5, this, configMAX_PRIORITIES - 2, &receive_task_handle_, 0);
    initialized_ = true;
}
