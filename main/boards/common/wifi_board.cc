...
void WifiBoard::EnterWifiConfigMode() {
    ...
    // 播报配置 WiFi 的提示
    application.Alert(Lang::Strings::WIFI_CONFIG_MODE, hint.c_str(), "gear", Lang::Sounds::OGG_1_8_PEIWANGMOSHI);
...
void WifiBoard::StartNetwork() {
    ...
    wifi_station.OnConnected([this](const std::string& ssid) {
        ...
        display->ShowNotification(notification.c_str(), 30000);
        // 播报 WiFi 连接成功提示
        app.PlaySound(Lang::Sounds::OGG_1_3_WIFILIANJIECHENGGON);
    });
    wifi_station.Start();
